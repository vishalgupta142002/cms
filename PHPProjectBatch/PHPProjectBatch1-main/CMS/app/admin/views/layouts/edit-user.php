        ...
        <main>
            ...
            <div class="row g-3">
                <div class="col-md-7 col-lg-8">
                    ...
                    <form class="needs-validation" novalidate action="?admin=show&module=users&action=profileuser"
                        method="post">
                        <div class="col-12">
                            <label for="user_name" class="form-label">Username</label>
                            <div class="input-group">
                                <input class="form-control" value=" <?php echo $user_profile['user_name']; ?>">
                            </div>
                        </div>
                        <div class=" row g-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="first_name" id="first_name" placeholder=""
                                    value="<?php echo $user_profile['first_name']; ?>" required maxlength="10">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="last_name" id="last_name" placeholder=""
                                    value="<?php echo $user_profile['last_name']; ?>" required>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <input type="email" class="form-control" name="email" id="email"
                                    placeholder="you@example.com" value="<?php echo $user_profile['email']; ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="address" id="address"
                                    placeholder="1234 Main St" value="<?php echo $user_profile['address']; ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <input type="number" class="form-control" name="mobile" id="mobile"
                                    placeholder="mobile number" value="<?php echo $user_profile['mobile']; ?>">
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" name="zip" id="zip" placeholder=""
                                    value="<?php echo $user_profile['zip']; ?>">
                                <div class="invalid-feedback">
                                    Zip code required.
                                </div>
                            </div>
                        ...
                        <button class="w-100 btn btn-primary btn-lg" type="submit" name="submit">Update
                            Profile</button>
                    </form>
                </div>
            </div>
