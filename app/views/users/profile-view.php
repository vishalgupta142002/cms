    ...
    <div class="container align-items: center  display: flex;">
        <main>
            ...
            <div class="py-5 text-center">
                <img class="d-block mx-auto mb-3 mt-3" src="assets/images/brand/bootstrap-logo.svg" alt="" width="72"
                    height="57">
                <h2>profile</h2>
                <p class="lead"></p>
            </div>
                ...
                <div class="col-md-6">
                    ...
                    <form class="needs-validation" novalidate action="?module=users&action=profile" method="post">
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="first_name" id="first_name"
                                    value="<?php echo $_SESSION['first_name'];?> " placeholder="" required
                                    maxlength="10">
                        ...
                        <div class="col-12">
                            ...
                            <input type="number" class="form-control" name="mobile" id="mobile" value="<?php echo $_SERVER['mobile'];?>
